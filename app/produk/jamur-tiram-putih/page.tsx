...
export const metadata: Metadata = {
  title: "Jamur Tiram Putih — MycoFarm",
  description: "Segar dipanen subuh. Tekstur lembut bersih, rasa gurih alami. Cocok untuk semua masakan. Dipanen setiap hari dari kumbung organik kami di Malang.",
};

const WA_NUM = "6281234567890";
const waText = encodeURIComponent("Halo MycoFarm! Saya ingin memesan Jamur Tiram Putih.");
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      <div className="mb-8 flex items-center gap-2 text-sm opacity-50">
        ...
        <span>/</span>
        <span className="text-success">Jamur Tiram Putih</span>
      </div>
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        <div className="rounded-3xl overflow-hidden border border-white/10 aspect-square">
          <img
            src="https://images.unsplash.com/photo-1549781568-eb67ed0da6a9?w=900&q=85&fit=crop"
            alt="Jamur Tiram Putih"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="lg:sticky lg:top-24">
          <span className="inline-block text-xs font-bold tracking-widest uppercase bg-success/20 text-success px-3 py-1 rounded-full mb-4">Bestseller</span>
          <h1 className="text-4xl lg:text-5xl font-bold mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Jamur Tiram Putih
          </h1>
          <p className="opacity-70 leading-relaxed mb-6 text-base">Segar dipanen subuh. Tekstur lembut bersih, rasa gurih alami. Cocok untuk semua masakan. Dipanen setiap hari dari kumbung organik kami di Malang.</p>
          <div className="text-3xl font-bold text-success mb-8">Rp 15.000/kg</div>
