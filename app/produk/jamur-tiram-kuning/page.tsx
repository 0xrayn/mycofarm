...
export const metadata: Metadata = {
  title: "Jamur Tiram Kuning — MycoFarm",
  description: "Golden Oyster Mushroom — warna menawan, aroma harum khas. Pilihan chef restoran bintang. Kaya vitamin D dan antioksidan tinggi.",
};

const WA_NUM = "6281234567890";
const waText = encodeURIComponent("Halo MycoFarm! Saya ingin memesan Jamur Tiram Kuning.");
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      <div className="mb-8 flex items-center gap-2 text-sm opacity-50">
        ...
        <span>/</span>
        <span className="text-success">Jamur Tiram Kuning</span>
      </div>
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        <div className="rounded-3xl overflow-hidden border border-white/10 aspect-square">
          <img
            src="https://images.unsplash.com/photo-1606923829579-0cb981a83e2e?w=900&q=85&fit=crop"
            alt="Jamur Tiram Kuning"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="lg:sticky lg:top-24">
          <span className="inline-block text-xs font-bold tracking-widest uppercase bg-success/20 text-success px-3 py-1 rounded-full mb-4">Premium</span>
          <h1 className="text-4xl lg:text-5xl font-bold mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Jamur Tiram Kuning
          </h1>
          <p className="opacity-70 leading-relaxed mb-6 text-base">Golden Oyster Mushroom — warna menawan, aroma harum khas. Pilihan chef restoran bintang. Kaya vitamin D dan antioksidan tinggi.</p>
          <div className="text-3xl font-bold text-success mb-8">Rp 25.000/kg</div>
