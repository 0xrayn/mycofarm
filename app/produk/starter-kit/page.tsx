...
export const metadata: Metadata = {
  title: "Starter Kit Lengkap — MycoFarm",
  description: "50 baglog siap panen + panduan lengkap + konsultasi gratis. Sempurna untuk mulai usaha budidaya jamur tiram dari nol. Termasuk spray bottle, termometer, dan buku panduan cetak.",
};

const WA_NUM = "6281234567890";
const waText = encodeURIComponent("Halo MycoFarm! Saya ingin memesan Starter Kit Lengkap.");
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16">
      <div className="mb-8 flex items-center gap-2 text-sm opacity-50">
        ...
        <span>/</span>
        <span className="text-success">Starter Kit Lengkap</span>
      </div>
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        <div className="rounded-3xl overflow-hidden border border-white/10 aspect-square">
          <img
            src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=900&q=85&fit=crop"
            alt="Starter Kit Lengkap"
            className="w-full h-full object-cover"
          />
        </div>
        <div className="lg:sticky lg:top-24">
          <span className="inline-block text-xs font-bold tracking-widest uppercase bg-success/20 text-success px-3 py-1 rounded-full mb-4">Rekomendasi</span>
          <h1 className="text-4xl lg:text-5xl font-bold mb-4" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Starter Kit Lengkap
          </h1>
          <p className="opacity-70 leading-relaxed mb-6 text-base">50 baglog siap panen + panduan lengkap + konsultasi gratis. Sempurna untuk mulai usaha budidaya jamur tiram dari nol. Termasuk spray bottle, termometer, dan buku panduan cetak.</p>
          <div className="text-3xl font-bold text-success mb-8">Rp 350.000/paket</div>
